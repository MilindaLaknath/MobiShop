...
//                IntfGroup intgrp = null;
      ...
      out.write("                            <form role=\"form\" class=\"form-inline\" action=\"admin_sales.jsp\">\n");
 ...
 if (dateto != null) {
      ...
      out.write("                                    <a href=\"http://localhost:8080/MobiShop/admin_sales_report.jsp?date_to=");
      out.print(dateto);
      out.write("&date_from=");
      out.print(datefrm);
      out.write("\" target=\"_blank\" ><button class=\"btn btn-primary pull-right\" style=\"margin-right: 20px;\">Print Report</button></a>\n");
      out.write("                                </div>\n");
      out.write("                            </form>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write("                            <tr>\n");
      out.write("                                <td>");
      out.print(tp.getStock().getProducts().getProdCode());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(tp.getStock().getBatchid());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(tp.getStock().getProducts().getItmName());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(tp.getQty());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(tp.getStock().getItmPrice());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(tp.getStock().getDiscount());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print((tp.getStock().getItmPrice() - tp.getStock().getDiscount()) * tp.getQty());
      out.write("</td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("\n");
      out.write("                            <a href=\"http://localhost:8080/MobiShop/admin_sales.jsp?frest=");
      out.print(frest - 20);
      out.print(url);
      out.write("\">\n");
