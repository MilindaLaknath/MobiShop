...
//                        cri.addOrder(Order.asc("brand"));
      ...
      out.write("                            <form role=\"form\" class=\"form-inline\" action=\"admin_users.jsp\">\n");
      ...
      out.print(utp.getGuestId());
      out.write('"');
      out.write('>');
      out.print(utp.getType());
      out.write("</option>\n");
      out.write("                                            ");
      ...
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(usr.getPersonalDetails().getFName() + " " + usr.getPersonalDetails().getLName());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(usr.getUserType().getType());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(usr.getPersonalDetails().getPhone());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(usr.getPersonalDetails().getAddress().getCity());
      out.write("</td>\n");
      out.write("                            <td>                                \n");
      out.write("                                <a href=\"http://localhost:8080/MobiShop/admin_edit_users.jsp?id=");
      out.print(usr.getUserId());
      ...
      out.write("\n");
      out.write("                            <a href=\"http://localhost:8080/MobiShop/admin_users.jsp?frest=");
      out.print(frest - 15);
      out.print(url);
      out.write("\">\n");
